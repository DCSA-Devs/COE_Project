...
const screens = [   //It has to be here as stack navigator contains login and other screen or we have to filter
    ...
    { component: 'Notes',name:'E-Books',imgSrc:require('../assets/images/EBooks.png'),key: '3' },
    { component: 'Notes',name:'Forum',imgSrc:require('../assets/images/Forum1.png'),key: '4' },
    { component: 'Notes',name:'Sample Question Paper',imgSrc:require('../assets/images/questionPaper.png'),key: '5' },
    { component: 'Notes',name:'Download Syllabus',imgSrc:require('../assets/images/PDF.png'),key: '6' },
    { component: 'Notes',name:'Upload Resource',imgSrc:require('../assets/images/Uploading.png'),key: '7' },
